...
### DkZ Quellen-Register -- APIs, Datenbanken, Dateien und Wissensquellen verwalten
...
![Lines](https://img.shields.io/badge/Lines-134-ffb800?style=for-the-badge)
...
```mermaid
graph TB
    A[Source Registry] --> B[index.html]
    A --> C[style.css]
    A --> D[script.js]
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-source-registry.git

# Oeffnen
cd dkz-source-registry
